// +AMGD
// $Id: threads.cpp 4 2012-08-24 02:28:17Z mike $
// file:  threads.cpp
// author:  See below.
 ...
 *    In order to lock a thread, a mutex can be created, locked and
 *    unlocked.
 *
 * REUSE NOTES
 *
...
/*                              FUNCTIONS                                  */
	...
	long Threads_Create_Mutex( char* name, Thread_Mutex* _thread_mutex )
	{
		*_thread_mutex = CreateMutex( NULL, FALSE, name );
		if( *_thread_mutex )
